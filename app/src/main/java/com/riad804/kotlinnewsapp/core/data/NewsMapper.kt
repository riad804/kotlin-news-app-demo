...
import com.riad804.kotlinnewsapp.core.data.local.ArticleEntity
import com.riad804.kotlinnewsapp.core.domain.Article
import com.riad804.kotlinnewsapp.core.data.remote.ArticleDto
...
fun ArticleDto.toArticle(): Article {
    return Article(
        ...
        imageUrl = imageUrl ?: "",
        content = "$articleId: As of 10:30 a.m. ET Friday — more than a week after landfall — nearly 735,000 electricity accounts were still without power across five states, according to Poweroutage.us: South Carolina (273,913), North Carolina (230,448), Georgia (203,111), Florida (13,794), and Virginia (13,191).\n" +
                "\n" +
